...
//#define debug     // Testpulse for logic analyser
    ...
    #elif defined(__AVR_ATtinyxy7__) // add aya 202005810
        #define MODE_TP1 PORTC.DIRSET = (1<<0);//PC0
        #define SET_TP1 PORTC.OUTSET = (1<<0);
        #define CLR_TP1 PORTC.OUTCLR = (1<<0);
        #define MODE_TP2 PORTC.DIRSET = (1<<1);//PC1
        #define SET_TP2 PORTC.OUTSET = (1<<1);
        #define CLR_TP2 PORTC.OUTCLR = (1<<1);
        #define MODE_TP3 PORTC.DIRSET = (1<<2);//PC2
        #define SET_TP3 PORTC.OUTSET = (1<<2);
        #define CLR_TP3 PORTC.OUTCLR = (1<<2);
        #define MODE_TP4 PORTC.DIRSET = (1<<3);//PC3
        #define SET_TP4  PORTC.OUTSET = (1<<3);
        #define CLR_TP4 PORTC.OUTCLR = (1<<3);
...
/////////////////////////////////////////////////////////////////////////
#ifdef DEBUG_PRINT
  #if defined(__AVR_ATtinyxy7__) // add aya 202005810
void SerialPrintPacketHex(char *strLabel, DCC_MSG * pDccMsg)
  #else
    ...
    else
    {
...
#endif
      {
        if( DccProcState.Flags & FLAGS_DCC_ACCESSORY_DECODER )
        {
          ...
          SerialPrintPacketHex("eDP: AccCmd: ", pDccMsg);
    #else
